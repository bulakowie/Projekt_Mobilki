...
class ListaPrzepisowActivity : ComponentActivity() {

    private lateinit var searchEditText: EditText
    private lateinit var container: LinearLayout
    private lateinit var przepisViewModel: PrzepisViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        przepisViewModel = ViewModelProvider(this)[PrzepisViewModel::class.java]
        ...
        przepisViewModel.allPrzepisy.observe(this) { przepisy ->
